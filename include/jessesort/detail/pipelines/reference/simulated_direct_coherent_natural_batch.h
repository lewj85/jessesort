#ifndef JESSESORT_SIMULATED_DIRECT_COHERENT_NATURAL_BATCH_H
#define JESSESORT_SIMULATED_DIRECT_COHERENT_NATURAL_BATCH_H
...
namespace jessesort::simulated_direct_coherent_natural_batch {
...
SimulatedInsertionResult<T> simulatePatienceInsertionBlueprintImpl(
    ...
    const bool confirmedShortSameDirectionPrefix =
        ...
        jessesort::simulated_direct_coherent_natural_batch::confirmedShortSameDirectionPrefix(
...
void sortImplCoreWithCheckpoint(std::vector<T>& arr, Less less, bool enableNaturalRunRoute,
    ...
    static_assert(std::is_copy_constructible_v<T> && std::is_copy_assignable_v<T>,
                  "jessesort::simulated_direct_coherent_natural_batch::sort requires copyable values because pile tails are stored by value");
    static_assert(std::is_move_constructible_v<T> && std::is_move_assignable_v<T>,
                  "jessesort::simulated_direct_coherent_natural_batch::sort requires movable values for merging");
