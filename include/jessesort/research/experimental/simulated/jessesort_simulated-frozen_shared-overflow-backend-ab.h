#ifndef JESSESORT_E588_SHARED_OVERFLOW_BACKEND_AB_H
#define JESSESORT_E588_SHARED_OVERFLOW_BACKEND_AB_H
...
namespace jessesort::experimental::e588_shared_overflow_backend_ab {
...
template <typename T, typename Less = std::less<T>>
void sortImpl(std::vector<T>& arr, Less less, bool bidirectionalBranchlessMerge, bool naturalRunRoute = false, bool enableSpecializedRoutes = false, bool patienceSortOverflow = false, bool enableCoherentValuePileCache = true, bool directHighEntropyOverflow = false) {
