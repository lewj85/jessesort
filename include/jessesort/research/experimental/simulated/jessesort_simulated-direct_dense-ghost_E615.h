#ifndef JESSESORT_SIMULATED_DIRECT_DENSE_GHOST_E615_H
#define JESSESORT_SIMULATED_DIRECT_DENSE_GHOST_E615_H
...
#include <jessesort/detail/pipelines/reference/simulated_direct_dense_ghost_e601.h>
#include <vector>
#include <cstdint>
#include <cstring>
#include <cstddef>
...
namespace jessesort::experimental::simulated_direct_dense_ghost_e615 {
...
// =========================================================
// E615: E607 16-bit per-element packed blueprint tags transplanted into E601 production fallback
...
SimulatedInsertionResult<T> simulatePatienceInsertionBlueprintImpl(
    ...
    const bool confirmedShortSameDirectionPrefix =
        ...
        jessesort::experimental::simulated_direct_dense_ghost_e615::confirmedShortSameDirectionPrefix(
...
void sort(std::vector<T>& arr, Less less = Less{}) {
    ...
    try {
        ...
        ++narrowFallbackCount;
        jessesort::simulated_direct_dense_ghost_e601::sort(arr, less);
    }
}
