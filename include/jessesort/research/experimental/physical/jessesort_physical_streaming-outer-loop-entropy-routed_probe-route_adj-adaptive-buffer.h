#ifndef JESSESORT_E487_PHYSICAL_STREAMING_OUTER_LOOP_ENTROPY_H
#define JESSESORT_E487_PHYSICAL_STREAMING_OUTER_LOOP_ENTROPY_H
...
namespace jessesort::experimental::physical_streaming_outer_loop_entropy {
...
void sort(std::vector<T>& arr, Less less = Less{}) {
    ...
    while (pos < n) {
        ...
        // Same retained high-entropy signature as E486, but ownership of the
        // suffix is handed to the maintained physical pillar through the range
        // adapter instead of simulated.
